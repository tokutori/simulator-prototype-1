...
| SIM-002 | done | JSON aircraft contract v0.8 | strict parse、model validation、schema、sample status、table外policy、environment/controller/failsafe/degraded-air-data profile |
